...
N_VARS=8               # Number of Boolean variables (n)
EXP_NAME="n8_m2_L0.95_s14_28_56_rep1000"
...
S_SAMPLES="14 28 56"   # Sampling sizes (s). Use -1 for Adaptive Mode.

# 5. --- 🛠️ Quality Control & Repetitions ---
REPS_STD=1000          # Standard repetitions per K
